    ...
    return(
        <div className="">
            ...
            <div className="pt-[40px]">
                ...
                <h3 className="text-gray-400 text-sm font-semibold uppercase tracking-wider mb-2">Patient Portal</h3>
            ...
            <div className="px-6 mb-4">
                <h3 className="text-gray-400 text-sm font-semibold uppercase tracking-wider mb-2">Quick Action</h3>
                <div className="space-y-1">
                    <button 
